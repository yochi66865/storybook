...
export const Default = () => ({
  component: AfuiFormContainerComponent,
...
Customized.story = {
  parameters: {
    cssVariablesKnobs: [
      {
        variable: '--afui-form-container-content-background-color',
        type: 'color',
        initialValue: '#f7f7f7',
      },
      {
        variable: '--afui-form-container-title-bar-background-color',
        type: 'color',
        initialValue: '#424242',
      },
      {
        variable: '--afui-form-container-font-size',
        type: 'text',
        initialValue: '0.5em',
      },
      {
        variable: '--afui-form-container-title-bar-font-size',
        type: 'text',
        initialValue: '1.5em',
      },
      {
        variable: '--afui-form-container-title-bar-text-color',
        type: 'color',
        initialValue: '#f7f7f7',
      },
      {
        variable: '--afui-form-container-close-icon-color',
        type: 'color',
        initialValue: '#000000',
      },
      {
        variable: '--afui-form-container-font-family',
        type: 'text',
        initialValue: 'Arial',
      },
    ],
